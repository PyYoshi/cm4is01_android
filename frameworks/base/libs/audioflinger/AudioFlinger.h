...
private:
    ...
    public:
        ...
        PlaybackThread (const sp<AudioFlinger>& audioFlinger, AudioStreamOutWrapper* output, int id);
        ...
        virtual     bool        streamMute(int stream) const;
                    ...
                    AudioStreamOutWrapper* getOutput() { return mOutput; }
    ...
    public:
        MixerThread (const sp<AudioFlinger>& audioFlinger, AudioStreamOutWrapper* output, int id);
        virtual             ~MixerThread();
    ...
    public:
        ...
        DirectOutputThread (const sp<AudioFlinger>& audioFlinger, AudioStreamOutWrapper* output, int id);
        ~DirectOutputThread();
    ...
    public:
        ...
        virtual void        onFirstRef();
                ...
                AudioStreamInWrapper* getInput() { return mInput; }
    ...
    mutable     Mutex                               mLock;
                ...
                AudioHardwareWrapper*               mAudioHardware;
